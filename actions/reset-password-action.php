<?php
/**
 * MedicOM — Reset Password Action (Admin)
 *
 ...
 *
 * For 'reset' the temporary password is shown to the admin ONCE via flash
 * message. The admin then communicates it to the user out-of-band.
 */
...
try {
    ...
    setFlash(
        'success',
        'Temporary password for ' . e($userName) . ' (' . e($req['email']) . '): ' .
 ...
 * Avoids ambiguous characters (0/O, 1/l/I) so it can be communicated verbally.
 */
